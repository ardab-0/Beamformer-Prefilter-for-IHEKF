class Parameters:
    ...
    sigma = 0.15  # std of complex gaussian noise (input signal noise)
    sigma_a = 1.5  # m/s**2
    dt = 0.1  # s
    N_theta = 100
    N_phi = 100
    ...
    antenna_kind = "regular_8_2"  # "original" or "square_4_4" or "irregular_4_4"
